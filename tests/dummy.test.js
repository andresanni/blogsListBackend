...
describe('total likes', () => {
  ...
  test('when list has one blog, equals the like of that', () => {
    const total = totalLikes(listWithOneBlog);
...
describe('favourite blog', () => {
  test('the most liked post is the right one', () => {
...
describe('author with more posts', () => {
  
  test('of mock array is the right one', () => {
